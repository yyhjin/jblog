	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="content" class="full-screen">
				...
				<form method="post" action="${pageContext.request.contextPath}/${blog.blogId}/admin/basic/update" enctype="multipart/form-data">
	 		      	<table class="admin-config">
			      		...
			      		<tr>
			      			<td class="t">로고이미지</td>
			      			<td><img id="image" src="${pageContext.request.contextPath }/${blog.image }"></td>      			
			      		</tr>      		
			      		<tr>
			      			<td class="t">&nbsp;</td>
